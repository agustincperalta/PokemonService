...
## Descripción
 ...
 Servicio SOAP en Java utilizando Spring Boot para consumir la API REST de [PokeAPI](https://pokeapi.co/api/v2/pokemon/). El servicio permite obtener información sobre Pokémon en tiempo real, como **habilidades, experiencia base, objetos retenidos, ID, nombre y áreas de encuentro**.
...
## Stack Tecnológico
 ...
 SOAP        <img src="https://img.icons8.com/color/48/000000/soap.png" width="24" height="24"> | REST (WebClient)  <img src="https://img.icons8.com/color/48/000000/api-settings.png" width="24" height="24"> |
...
La consola de H2 está expuesta para que puedas verificar los datos almacenados en la base de datos. Para acceder a la consola y ejecutar consultas, usa la siguiente URL y credenciales:
...
La información se almacena en la tabla `REQUEST_LOG`. Puedes ejecutar la siguiente consulta SQL para ver los registros:
...
Los resultados del **análisis** y **coverage** se muestran tanto en GitHub como en SonarCloud.
